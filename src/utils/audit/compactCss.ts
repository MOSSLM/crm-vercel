...
:root{--nuit:#0B1D3A;--azur:#3A7BD5;--brume:#B5D0F0;--creme:#F4F1EB;--blanc:#E8F3FF;--page-w:794px;--page-h:1123px}
...
.half+.half{border-top:1px dashed rgba(11,29,58,.18)}
...
.cover-date{font-size:9px;letter-spacing:.2em;color:rgba(181,208,240,.45);font-weight:500;text-transform:uppercase}
...
.cover-subtitle{font-size:11.5px;line-height:1.75;color:rgba(181,208,240,.62);max-width:360px;font-weight:300;margin-top:16px}
.cover-foot{display:grid;grid-template-columns:1fr auto;gap:18px;align-items:end}
.cover-client{padding:16px 20px;border:1px solid rgba(181,208,240,.16);border-radius:4px;background:rgba(58,123,213,.07)}
.cover-client-label{font-size:8px;letter-spacing:.22em;text-transform:uppercase;color:rgba(181,208,240,.45);font-weight:500;margin-bottom:7px}
...
.cover-client-meta{font-size:10px;color:rgba(181,208,240,.5);margin-top:3px}
.demo-cta{display:block;width:258px;padding:11px 12px 10px;border:1px solid rgba(58,123,213,.4);border-radius:6px;background:rgba(58,123,213,.12)}
...
.mockup{background:rgba(255,255,255,.05);border-radius:3px;overflow:hidden;border:1px solid rgba(181,208,240,.12)}
...
.mockup-url{flex:1;height:11px;background:rgba(255,255,255,.07);border-radius:2px;display:flex;align-items:center;gap:3px;padding-left:4px;font-size:6px;color:rgba(181,208,240,.5);overflow:hidden;white-space:nowrap}
.mockup-url img{width:7px;height:7px}
.mockup-screen{position:relative;height:86px;background:rgba(11,29,58,.6);overflow:hidden}
...
.sk-hero{height:12px;width:68%;background:rgba(58,123,213,.2);border-radius:2px}
.sk-line{height:4px;background:rgba(255,255,255,.06);border-radius:2px}
.sk-btn{height:15px;width:48px;background:rgba(58,123,213,.32);border-radius:3px;margin-top:3px}
...
.panel-mark{display:flex;align-items:center;gap:7px;font-size:8px;letter-spacing:.28em;text-transform:uppercase;color:rgba(11,29,58,.28);font-weight:500}
...
.panel-intro{font-size:var(--f-intro,11.5px);line-height:1.75;color:rgba(11,29,58,.6);max-width:530px;margin-top:9px;font-weight:300}
...
.problem-card{padding:13px 15px;border:1px solid rgba(58,123,213,.16);border-radius:4px;background:rgba(11,29,58,.022);display:grid;grid-template-columns:auto 1fr;gap:9px;align-items:start}
.alert-icon{width:22px;height:22px;background:rgba(58,123,213,.1);border:1px solid rgba(58,123,213,.2);border-radius:4px;display:flex;align-items:center;justify-content:center}
.problem-title{font-size:11px;font-weight:500;color:var(--nuit);line-height:1.35}
.problem-desc{font-size:9.5px;line-height:1.6;color:rgba(11,29,58,.55);margin-top:5px}
.quote-strip{padding:15px 20px;border-left:2px solid var(--azur);background:rgba(58,123,213,.045);border-radius:0 4px 4px 0}
...
.quote-src{font-size:8px;letter-spacing:.15em;text-transform:uppercase;color:rgba(11,29,58,.38);font-weight:500;margin-top:8px}
/* ── 02 Solution ──────────────────────────────────────────────────── */
.solution-list{display:flex;flex-direction:column}
.solution-item{display:grid;grid-template-columns:26px 1fr auto;align-items:start;gap:14px;padding:11px 0;border-bottom:1px solid rgba(11,29,58,.07)}
.solution-item:last-child{border-bottom:none}
.solution-num{font-family:'Cormorant Garamond',serif;font-size:22px;font-weight:300;color:rgba(58,123,213,.28);line-height:1}
.solution-name{font-size:12px;font-weight:500;color:var(--nuit);margin-bottom:3px}
.solution-desc{font-size:10px;line-height:1.6;color:rgba(11,29,58,.55)}
.solution-tag{font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--azur);background:rgba(58,123,213,.08);padding:4px 7px;border-radius:2px;white-space:nowrap;font-weight:500}
/* ── 03 Ce que vous recevez ───────────────────────────────────────── */
.recu-table{background:#fff;border:1px solid rgba(58,123,213,.16);border-radius:5px;overflow:hidden}
.recu-th{display:grid;grid-template-columns:118px 1fr 118px;gap:22px;padding:9px 20px;background:rgba(58,123,213,.055);border-bottom:1px solid rgba(58,123,213,.16);font-size:8px;letter-spacing:.2em;text-transform:uppercase;color:var(--azur);font-weight:500}
.recu-th>div:last-child{text-align:center}
.recu-row{display:grid;grid-template-columns:118px 1fr 118px;gap:22px;align-items:center;padding:19px 20px;border-bottom:1px solid rgba(58,123,213,.11)}
...
.recu-text{font-size:11px;line-height:1.75;color:rgba(11,29,58,.62);font-weight:300;text-wrap:pretty}
.recu-fix{font-size:8.5px;line-height:1.55;letter-spacing:.03em;color:var(--azur);background:rgba(58,123,213,.07);border:1px solid rgba(58,123,213,.17);border-radius:2px;padding:6px 10px;text-align:center;justify-self:center;width:fit-content}
/* ── 04 Investissement ────────────────────────────────────────────── */
...
.invest-label{font-size:11px;color:rgba(181,208,240,.75)}
.invest-sublabel{font-size:9px;color:rgba(181,208,240,.38);margin-top:3px;line-height:1.5;max-width:330px}
.invest-amount{font-family:'Cormorant Garamond',serif;font-weight:300;font-size:19px;color:var(--blanc);white-space:nowrap}
.invest-row-total{display:grid;grid-template-columns:1fr auto;align-items:baseline;gap:22px;border-top:1px solid rgba(181,208,240,.2);margin-top:6px;padding-top:14px}
...
.invest-note{margin-top:14px;font-size:8.5px;color:rgba(181,208,240,.42);line-height:1.65;border-top:1px solid rgba(181,208,240,.09);padding-top:11px}
.secondary-card{margin-top:11px;background:#fff;border:1px solid rgba(58,123,213,.18);border-radius:6px;padding:15px 20px;display:flex;align-items:flex-end;justify-content:space-between;gap:20px}
...
.secondary-desc{font-size:9.5px;color:rgba(11,29,58,.55);margin-top:4px;line-height:1.55;max-width:340px}
.secondary-amount{font-family:'Cormorant Garamond',serif;font-weight:300;font-size:24px;color:var(--nuit);white-space:nowrap}
.secondary-from{font-size:9px;color:rgba(11,29,58,.45);text-align:right}
...
.opt-card{background:#fff;border:1px solid rgba(58,123,213,.16);border-radius:5px;padding:14px 16px;display:flex;flex-direction:column}
...
.opt-desc{font-size:10px;line-height:1.65;color:rgba(11,29,58,.55);margin-top:7px;font-weight:300}
.opt-note{font-size:8px;letter-spacing:.16em;text-transform:uppercase;color:var(--azur);font-weight:500}
.opt-foot{display:flex;align-items:baseline;justify-content:space-between;gap:10px;margin-top:auto;padding-top:9px;border-top:1px solid rgba(58,123,213,.14)}
.opt-amount{font-family:'Cormorant Garamond',serif;font-size:21px;font-weight:300;color:var(--nuit);white-space:nowrap}
.opt-amount i{font-family:'DM Sans',sans-serif;font-style:normal;font-size:9px;color:rgba(11,29,58,.45)}
.addl-grid{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:11px}
.addl-card{padding:11px 13px;background:#fff;border:1px solid rgba(58,123,213,.12);border-radius:4px;display:flex;align-items:baseline;justify-content:space-between;gap:10px}
...
.step-card{padding:14px 16px;border:1px solid rgba(11,29,58,.09);border-radius:4px}
.step-num{font-family:'Cormorant Garamond',serif;font-size:30px;font-weight:300;color:rgba(58,123,213,.18);line-height:1;margin-bottom:6px}
.step-title{font-size:11px;font-weight:500;color:var(--nuit);margin-bottom:4px}
.step-desc{font-size:9.5px;color:rgba(11,29,58,.5);line-height:1.55}
.cta-block{background:rgba(58,123,213,.055);border:1px solid rgba(58,123,213,.16);border-radius:4px;padding:16px 20px;display:flex;align-items:center;justify-content:space-between;gap:20px}
.cta-title{font-family:'Cormorant Garamond',serif;font-size:17px;font-weight:300;color:var(--nuit);margin-bottom:3px}
.cta-sub{font-size:10px;color:rgba(11,29,58,.5)}
...
.cta-btn-mail{background:#fff;border:1px solid rgba(58,123,213,.35);color:var(--azur)}
.cta-btn-mail span{color:rgba(11,29,58,.4)}
.cta-btn-mail b{font-size:12.5px}
.cta-contact-web{font-size:9px;color:rgba(11,29,58,.4);margin-top:5px}
.demo-push{display:flex;align-items:center;gap:16px;padding:11px 16px;border:1px solid rgba(58,123,213,.28);border-radius:4px;background:linear-gradient(90deg,rgba(58,123,213,.09),rgba(58,123,213,.02))}
.demo-push-txt{flex:1;min-width:0}
.demo-push-shot{width:124px;height:74px;flex-shrink:0;border:1px solid rgba(58,123,213,.25);border-radius:3px;overflow:hidden;background:rgba(58,123,213,.06);position:relative}
.demo-push-shot image-slot{position:absolute;inset:0;font-size:8px;color:rgba(11,29,58,.4)}
...
.demo-push-url{font-size:9.5px;color:rgba(11,29,58,.45);margin-top:3px}
...
.sign{display:flex;align-items:center;gap:13px;padding-top:14px;border-top:1px solid rgba(11,29,58,.07)}
.sign-text{font-size:9px;color:rgba(11,29,58,.35);line-height:1.65}
/* ── Pied de page A4 ──────────────────────────────────────────────── */
.sheet-foot{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-top:auto;padding-top:11px;border-top:1px solid rgba(11,29,58,.08)}
.sheet-foot span{font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:rgba(11,29,58,.3)}
.sheet-foot b{font-family:'Cormorant Garamond',serif;font-size:12px;letter-spacing:0;text-transform:none;color:rgba(11,29,58,.28);font-weight:400}
...
.shot-frame{border:1px solid rgba(181,208,240,.22);border-radius:5px 5px 0 0;overflow:hidden;background:rgba(255,255,255,.05);border-bottom:none}
.shot-frame .mockup-chrome{padding:6px 9px}
.shot-frame .mockup-url{height:14px;font-size:7.5px;padding-left:6px}
.shot-screen{position:relative;height:178px;background:rgba(11,29,58,.5)}
.shot-screen image-slot{position:absolute;inset:0;color:rgba(181,208,240,.6)}
/* ── 01 · Le relevé ────────────────────────────────────────────────── */
...
.score-hero{display:grid;grid-template-columns:176px 1fr;background:var(--ivoire);border:1px solid rgba(11,29,58,.11);border-radius:5px;overflow:hidden}
.score-num{padding:11px 16px;border-right:1px solid rgba(11,29,58,.09);background:rgba(11,29,58,.018);display:flex;flex-direction:column;justify-content:center}
.score-lbl{font-size:8px;letter-spacing:.2em;text-transform:uppercase;color:rgba(11,29,58,.42);font-weight:500}
...
.score-val s{text-decoration:none;font-size:11.5px;color:rgba(11,29,58,.4)}
.score-sub{font-size:8.5px;line-height:1.5;color:rgba(11,29,58,.38);margin-top:6px}
...
.mk-p{color:var(--nuit)}.mk-m{color:rgba(11,29,58,.4)}.mk-s{color:var(--azur)}
.rail-axis{display:flex;justify-content:space-between;font-size:7.5px;letter-spacing:.12em;text-transform:uppercase;color:rgba(11,29,58,.3);font-weight:500;margin-top:7px}
.rail-legend{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-top:7px;padding-top:9px;border-top:1px solid rgba(11,29,58,.08)}
...
.lg-p{color:var(--nuit)}.lg-m{color:rgba(11,29,58,.4)}.lg-s{color:var(--azur)}
.lg b{font-size:9.5px;font-weight:500;color:var(--nuit);display:block}
.lg b em{font-style:normal;color:currentColor}
.lg small{font-size:8px;color:rgba(11,29,58,.4);display:block;margin-top:2px;line-height:1.4}
.ax-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}
.ax-card{background:var(--ivoire);border:1px solid rgba(11,29,58,.1);border-radius:4px;padding:8px 12px}
.ax-top{display:flex;align-items:baseline;justify-content:space-between;gap:8px}
.ax-nm{font-size:8px;letter-spacing:.15em;text-transform:uppercase;color:rgba(11,29,58,.45);font-weight:500}
...
.ax-note s{text-decoration:none;font-size:8.5px;color:rgba(11,29,58,.32);margin-left:1px}
.ax-bar{display:flex;gap:1.5px;margin:6px 0 7px}
.ax-bar i{flex:1;height:3px;background:rgba(11,29,58,.09)}
.ax-bar i.on{background:var(--azur)}
.ax-v{font-size:10.5px;font-weight:500;color:var(--nuit);line-height:1.35}
.ax-e{font-size:8.8px;line-height:1.45;color:rgba(11,29,58,.5);margin-top:4px}
.verdict-strip{padding:9px 17px;border-left:2px solid var(--azur);background:rgba(58,123,213,.045);border-radius:0 4px 4px 0}
...
.verdict-strip span{display:block;font-size:8px;letter-spacing:.15em;text-transform:uppercase;color:rgba(11,29,58,.38);font-weight:500;margin-top:6px}
/* ── 02 · Constat → réponse ────────────────────────────────────────── */
.ba-heads{display:grid;grid-template-columns:1fr 1fr;gap:0}
.ba-h{font-size:8px;letter-spacing:.18em;text-transform:uppercase;font-weight:500;color:rgba(11,29,58,.35);padding-left:18px}
.ba-h-a{color:var(--azur);padding-left:20px}
.ba-stack{display:flex;flex-direction:column;gap:9px}
.ba-row{position:relative;display:grid;grid-template-columns:1fr 1fr;background:#fff;border:1px solid rgba(11,29,58,.12);border-radius:4px;overflow:hidden}
.ba-side{padding:14px 18px 15px;display:flex;flex-direction:column;justify-content:center;min-height:66px}
.ba-after{background:rgba(58,123,213,.055);border-left:1px dashed rgba(58,123,213,.45);padding-left:20px}
...
.ba-d{font-size:9.5px;line-height:1.5;color:rgba(11,29,58,.48);margin-top:6px;max-width:290px}
.ba-arrow{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:19px;height:19px;border-radius:50%;background:#fff;border:1px solid rgba(58,123,213,.35);color:var(--azur);font-size:9px;line-height:17px;text-align:center}
.plus-strip{display:grid;grid-template-columns:auto 1fr auto;gap:15px;align-items:center;padding:11px 17px;border:1px dashed rgba(11,29,58,.2);border-radius:4px;background:rgba(11,29,58,.016)}
...
.plus-l{font-size:9px;color:rgba(11,29,58,.45);margin-top:4px;line-height:1.55}
.plus-c{font-size:8px;letter-spacing:.16em;text-transform:uppercase;color:rgba(11,29,58,.33);font-weight:500;text-align:right;white-space:nowrap}`;
