 ...
 *      la même palette : nuit #0B1D3A, azur #3A7BD5, brume #B5D0F0, crème
 *      #F4F1EB — cf. `C` dans `AuditShared.tsx`.
 *
...
:root{--nuit:#0B1D3A;--azur:#3A7BD5;--brume:#B5D0F0;--creme:#F4F1EB;--blanc:#E8F3FF;--w:430px}
...
.m-sky{position:absolute;inset:0;background:radial-gradient(ellipse 300px 260px at 88% 10%,rgba(58,123,213,.4) 0%,transparent 62%),radial-gradient(ellipse 320px 300px at 6% 96%,rgba(58,123,213,.22) 0%,transparent 60%)}
...
.m-intro{font-size:14px;line-height:1.72;color:rgba(11,29,58,.6);margin-top:12px;font-weight:300}
.dark .m-intro{color:rgba(181,208,240,.62)}
.m-body{flex:1;display:flex;flex-direction:column;gap:14px;padding:22px 0 0}
.m-count{font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:rgba(11,29,58,.35);font-weight:500;margin-top:16px}
...
/* Pied d'écran */
.m-foot{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-top:auto;padding-top:13px;border-top:1px solid rgba(11,29,58,.08)}
.m-foot span{font-size:8.5px;letter-spacing:.14em;text-transform:uppercase;color:rgba(11,29,58,.32);font-weight:500}
.m-foot b{font-family:'Cormorant Garamond',Georgia,serif;font-size:12px;color:rgba(11,29,58,.3);font-weight:400}
.dark .m-foot{border-color:rgba(181,208,240,.14)}
.dark .m-foot span,.dark .m-foot b{color:rgba(181,208,240,.4)}
/* Cartes */
.m-card{padding:18px 20px;border:1px solid rgba(58,123,213,.16);border-radius:6px;background:rgba(11,29,58,.022)}
.m-card-head{display:flex;align-items:flex-start;gap:11px}
.alert-icon{width:26px;height:26px;background:rgba(58,123,213,.1);border:1px solid rgba(58,123,213,.2);border-radius:5px;display:flex;align-items:center;justify-content:center;flex-shrink:0}
.m-card-title{font-size:14.5px;font-weight:500;line-height:1.4;color:var(--nuit)}
.m-card-desc{font-size:13px;line-height:1.7;color:rgba(11,29,58,.55);margin-top:9px}
.m-sol{display:flex;flex-direction:column;gap:0;padding:18px 20px;border:1px solid rgba(58,123,213,.16);border-radius:6px;background:#fff}
.m-sol-top{display:flex;align-items:baseline;gap:12px}
.m-sol-num{font-family:'Cormorant Garamond',Georgia,serif;font-size:26px;font-weight:300;color:rgba(58,123,213,.3);line-height:1}
.m-sol-name{font-size:15px;font-weight:500;color:var(--nuit)}
.m-tag{font-size:9px;letter-spacing:.14em;text-transform:uppercase;color:var(--azur);background:rgba(58,123,213,.08);padding:5px 9px;border-radius:3px;align-self:flex-start;margin-top:11px;font-weight:500}
.m-liv{padding:18px 20px;border-radius:6px;background:#fff;border:1px solid rgba(58,123,213,.13)}
...
.check-badge{width:20px;height:20px;border-radius:50%;background:rgba(58,123,213,.12);border:1px solid rgba(58,123,213,.25);display:flex;align-items:center;justify-content:center;flex-shrink:0}
.m-liv-items{display:flex;flex-direction:column;gap:6px}
.m-liv-item{font-size:12.5px;color:rgba(11,29,58,.55);line-height:1.55;padding-left:11px;position:relative}
.m-liv-item::before{content:'—';position:absolute;left:0;top:0;color:rgba(58,123,213,.45);font-size:9px}
/* Citation */
...
/* Mockup navigateur */
.m-shot{border-radius:8px;overflow:hidden;border:1px solid rgba(58,123,213,.22);background:var(--nuit);box-shadow:0 18px 40px -24px rgba(11,29,58,.5)}
.mockup-chrome{background:rgba(11,29,58,.9);padding:7px 9px;display:flex;align-items:center;gap:7px}
...
.mockup-screen{position:relative;height:340px;background:rgba(11,29,58,.75);overflow:hidden}
...
.sk-hero{height:26px;width:70%;background:rgba(58,123,213,.22);border-radius:3px}
.sk-line{height:7px;background:rgba(255,255,255,.06);border-radius:3px}
.sk-btn{height:26px;width:96px;background:rgba(58,123,213,.34);border-radius:4px;margin-top:6px}
/* Boutons */
...
.m-btn-ghost{background:rgba(58,123,213,.1);border:1px solid rgba(181,208,240,.28);color:var(--blanc)}
.m-btn-line{background:transparent;border:1px solid rgba(58,123,213,.3);color:var(--azur)}
.m-actions{display:flex;flex-direction:column;gap:10px}
.m-note{font-size:11px;color:rgba(11,29,58,.42);line-height:1.6;text-align:center}
...
.m-alt{padding:18px 20px;background:#fff;border:1px solid rgba(58,123,213,.18);border-radius:6px}
.m-alt-dark{margin-top:20px;padding:17px 19px;border:1px solid rgba(181,208,240,.18);border-radius:6px;background:rgba(58,123,213,.08)}
...
.m-alt-desc{font-size:12.5px;color:rgba(11,29,58,.55);line-height:1.6;margin-top:7px}
.m-alt-price{display:flex;align-items:baseline;justify-content:space-between;gap:12px;margin-top:14px;padding-top:13px;border-top:1px solid rgba(11,29,58,.08)}
.m-alt-from{font-size:11px;color:rgba(11,29,58,.45)}
.m-alt-amount{font-family:'Cormorant Garamond',Georgia,serif;font-weight:300;font-size:26px;color:var(--nuit)}
/* Étapes */
.m-step{display:grid;grid-template-columns:36px 1fr;gap:14px;align-items:start;padding:16px 0;border-bottom:1px solid rgba(11,29,58,.07)}
.m-step:last-child{border-bottom:none}
.m-step-num{font-family:'Cormorant Garamond',Georgia,serif;font-size:26px;font-weight:300;color:rgba(58,123,213,.35);line-height:1}
.m-step-title{font-size:14.5px;font-weight:500;color:var(--nuit)}
.m-step-desc{font-size:12.5px;color:rgba(11,29,58,.55);line-height:1.65;margin-top:5px}
...
.m-axe{padding:16px 18px;border:1px solid rgba(58,123,213,.16);border-radius:6px;background:#fff}
...
.m-axe-bar{height:5px;border-radius:3px;background:rgba(11,29,58,.08);margin-top:10px;overflow:hidden}
...
.m-preuve-lib{color:rgba(11,29,58,.6);flex:1}
.m-preuve-val{color:var(--nuit);font-weight:500;white-space:nowrap}
.m-preuve-seuil{font-size:10.5px;color:rgba(11,29,58,.35);white-space:nowrap}
...
.m-vs-name{font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:rgba(11,29,58,.4);font-weight:500}
...
.m-vs-shot{border-radius:6px;overflow:hidden;border:1px solid rgba(58,123,213,.2);background:rgba(11,29,58,.75);height:190px;position:relative}
...
/* Méthode */
.m-methode{font-size:11.5px;line-height:1.75;color:rgba(11,29,58,.5)}
.dark .m-methode{color:rgba(181,208,240,.5)}
.m-methode b{font-weight:500;color:rgba(11,29,58,.7)}
