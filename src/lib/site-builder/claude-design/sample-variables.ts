...
export const CLAUDE_DESIGN_VARIABLES: Array<{ token: string; label: string; sample: string }> = [
  ...
  { token: "{{ entreprise.ville }}", label: "Ville (adresse)", sample: "Seynod" },
  { token: "{{ entreprise.ville_seo }}", label: "Ville SEO (grande ville)", sample: "Annecy" },
  ...
  { token: "{{ entreprise.location }}", label: "Zone principale (alias de Ville SEO)", sample: "Annecy" },
