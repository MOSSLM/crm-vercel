...
import { OpportunityCard } from './pipeline/OpportunityCard';
import { ItemType } from './pipeline/constants';
...
export const PipelinePage: React.FC = () => {
  ...
  const { stageConfigs, toggleStageVisibility, toggleStageSize } = usePipelineStages(pipelineStages);
