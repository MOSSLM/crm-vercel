...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-20 mb-3 flex h-16 shrink-0 items-center gap-2 rounded-2xl border border-border/70 bg-card/85 shadow-sm backdrop-blur-md transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
