...
// Single source of truth (framework-free) so the server-side draft preview can
// share these without importing this "use client" module.
import { CLAUDE_DESIGN_VARIABLES, SAMPLE_VARIABLES } from "@/lib/site-builder/claude-design/sample-variables";
export { CLAUDE_DESIGN_VARIABLES, SAMPLE_VARIABLES };
