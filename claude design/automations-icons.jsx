// automations-icons.jsx — extra icons specific to automations.
// Extends the base Icon set with channel + flow icons.
...
const __XICONS = {
  ...
  bolt2:     <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />,
  ...
  snooze:    <><circle cx="12" cy="12" r="9" /><text x="12" y="15.5" fontSize="9" textAnchor="middle" fill="currentColor" stroke="none" fontFamily="var(--font-mono)">Zz</text></>,
...
// Extended icon — falls back to base Icon if not in our set
function XI({ name, className = "ico", strokeWidth, ...rest }) {
  const path = __XICONS[name];
  if (path) {
    return (
